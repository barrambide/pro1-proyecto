  ...
  .then(function (respuesta) {
   ...
   .then(function(data){
    ...
    for (let i = 0; i < 5 ; i++) {
      ...
      <div class="divPadre4">
          <div class="divHija4">
              <span class="saltopagina1"><a href="detail-canciones.html?id=${tracks[i].album.id}" class="aLetra"><i>${tracks[i].album.type}
                          <br><i>${tracks[i].album.title} </i></i></a></span>
              <br>
   ...
   .then(function (respuesta) {
    ...
    .then(function(data){
     ...
     for (let i = 0; i < 5 ; i++) {
       ...
       <div class="divPadre4">
           <div class="divHija4">
               <span class="saltopagina1"><a href="detail-canciones.html?id=${tracks[i].artist.id}" class="aLetra"><i>${tracks[i].artist.name}
                           <br><i>${tracks[i].artist.type} </i></i></a></span>
               <br>
               <a href="detail-artistas.html"><img src="${tracks[i].artist.picture}" alt="mariabecerra"
                       height="190px"></a>
           </div>
       </div>
   </article>`
